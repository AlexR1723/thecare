...
urlpatterns = [
    ...
    url(r'^(?P<head_url>[A-Za-z_]+)/$', views.Catalog, name="Catalog"),
    url(r'^(?P<head_url>[A-Za-z_]+)/(?P<filter>[a-z_]+)/$', views.Catalog_filter, name="Catalog_filter"),
    url(r'^(?P<head_url>[A-Za-z_]+)/(?P<page>[0-9]+)/$', views.Catalog_page, name="Catalog_page"),
    url(r'^(?P<head_url>[A-Za-z_]+)/(?P<page>[0-9]+)/(?P<filter>[a-z_]+)/$', views.Catalog_page_filter, name="Catalog_page_filter"),
    url(r'^(?P<head_url>[A-Za-z_]+)/(?P<text>[^/]+)/$', views.Catalog_search, name="Catalog_search"),
    url(r'^(?P<head_url>[A-Za-z_]+)/(?P<text>[^/]+)/(?P<filter>[a-z_]+)/$', views.Catalog_search_filter, name="Catalog_search_filter"),
    url(r'^(?P<head_url>[A-Za-z_]+)/(?P<text>[^/]+)/(?P<page>[^/]+)/$', views.Catalog_search_page, name="Catalog_search_page"),
    url(r'^(?P<head_url>[A-Za-z_]+)/(?P<text>[^/]+)/(?P<page>[^/]+)/(?P<filter>[a-z_]+)/$', views.Catalog_search_page_filter,
